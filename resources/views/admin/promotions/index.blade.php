...
<div class="container-fluid">
	...
	<tr>
		...
		<td>
			...
			<a class="btn btn-danger delete-confirm" data-toggle="modal" data-target="#modal-delete" data-id="{{ config('blog.prefix_url') }}admin/promotions/{{ $promotion->id }}">Delete</a>
        	@endpermission
		</td>
	</tr>
	@endforeach
