...
<div class="container-fluid">
	...
	<tr>
		...
		<td>
			<form method="POST" action="{{ route('admin.approve.update',$item->id) }}">
			<input type="hidden" name="_token" value="{{ csrf_token() }}">
			@permission('approve-update')
			<button type="submit" class="btn btn-success btn-xs" href="">Aktifkan</button>
			@endpermission
