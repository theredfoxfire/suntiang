			        ...
			        @foreach ($datas as $item)
                        ...
                        <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                            <div class="product">
                                ...
                                <p class="text-grey text-linethrough">{{ formattingNumber($item->catering_price_100) }}</p>
                                <p class="text-green">Now Only <span>{{ formattingNumber($item->catering_price_100) }}</span></p>
