...
<div class="slider-1slide">
  <div>
      <div class="overlay-text">
          ...
          <a href="{{ route('item.dailyMeal') }}" class="btn btn-lg btn-flare overlay">SEE ALL MENU</a>
      </div>
  </div>
  <div>
      <div class="overlay-text">
                      ...
                      <div class="container">
                          <div class="row">
                              <div class="col-sm-12">
                                  ...
                                  <div class="row">
                                      <div class="col-sm-4">
                                          <a href="{{ route('item.dailyMeal') }}" class="thumb-damion text-center">
                                      ...
                                      <div class="col-sm-4 thumb-damion text-center">
                                          <a href="{{ route('item.catering') }}" class="thumb-damion text-center">
                                      ...
                                      <div class="col-sm-4 thumb-damion text-center">
                                          <a href="{{ route('item.snackbox') }}" class="thumb-damion text-center">
