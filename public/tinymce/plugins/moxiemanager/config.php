<?php
// General
$moxieManagerConfig['general.license'] = false;
...
$moxieManagerConfig['general.temp_dir'] = __DIR__."/../../../../../../../userfiles/media";
$moxieManagerConfig['general.allow_override'] = 'hidden_tools,disabled_tools';
// echo $_SERVER["DOCUMENT_ROOT"]."/www.fibreslimdietsehat.com/apps/userfiles/media";
// echo dirname(__FILE__);
// Filesystem
//$moxieManagerConfig['filesystem.rootpath'] = $_SERVER["DOCUMENT_ROOT"]."/www.fibreslimdietsehat.com/apps/userfiles/media;".$_SERVER["DOCUMENT_ROOT"]."/userfiles/media";  ///webroot/uploads';
//echo $moxieManagerConfig['filesystem.rootpath'];
$moxieManagerConfig['filesystem.rootpath'] = '../../../../../../../userfiles/media/';
...
$moxieManagerConfig['thumbnail.auto_generate'] = false;
...
// Authentication
$moxieManagerConfig['authenticator'] = false;// 'BasicAuthenticator';
...
$moxieManagerConfig['storage.path'] = './userfiles/media';
